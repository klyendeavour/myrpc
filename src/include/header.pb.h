...
PROTOBUF_NAMESPACE_OPEN
template<> ::header_proto::Header* Arena::CreateMaybeMessage<::header_proto::Header>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace header_proto {
...
class Header final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:header_proto.Header) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:header_proto.Header)
 private:
  class _Internal;
...
inline const std::string& Header::service_name() const {
  // @@protoc_insertion_point(field_get:header_proto.Header.service_name)
...
void Header::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.service_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:header_proto.Header.service_name)
}
inline std::string* Header::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:header_proto.Header.service_name)
  return _s;
}
...
inline std::string* Header::release_service_name() {
  // @@protoc_insertion_point(field_release:header_proto.Header.service_name)
...
inline void Header::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:header_proto.Header.service_name)
}
...
inline const std::string& Header::method_name() const {
  // @@protoc_insertion_point(field_get:header_proto.Header.method_name)
...
void Header::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.method_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:header_proto.Header.method_name)
}
inline std::string* Header::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:header_proto.Header.method_name)
  return _s;
}
...
inline std::string* Header::release_method_name() {
  // @@protoc_insertion_point(field_release:header_proto.Header.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:header_proto.Header.method_name)
}
...
inline uint32_t Header::arg_size() const {
  // @@protoc_insertion_point(field_get:header_proto.Header.arg_size)
...
inline void Header::set_arg_size(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:header_proto.Header.arg_size)
}
